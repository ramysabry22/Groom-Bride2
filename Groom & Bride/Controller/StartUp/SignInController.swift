...
class SignInController: UIViewController,UITextFieldDelegate {    
    ...
    private func setupConstrains(){
        ...
        SignInButton.anchor(top: forgetPasswordLabel.bottomAnchor, leading: scrollView.leadingAnchor, bottom: nil, trailing: scrollView.trailingAnchor, padding: .init(top: 40, left: 0, bottom: 0, right: 0),size: CGSize(width: 0, height: 45))
...
//    }()
    ...
    lazy var forgetPasswordLabel : UILabel = {
        ...
        //label.tintColor = UIColor.signTitleColor()
        label.font = UIFont.boldSystemFont(ofSize: 14)
        label.backgroundColor = UIColor.clear
        label.numberOfLines = 0
        label.textAlignment = .right
        label.textColor = UIColor.darkGray
        let tapGesture2 = UITapGestureRecognizer(target: self, action: #selector(self.forgetPasswordAction(_:)))
